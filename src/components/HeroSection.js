...
import Profile from "../../src/assets/image/farouk.jpg";
import Button from './button';
import Ptex from './Ptex';
import SocialMediaArrow from "../assets/image/social-media-arrow.svg";
import ScrollDownArrow from "../assets/image/scroll-down-arrow.svg";
      ...
      <div className="hero">
        <div className="container">
          <h1 className="hero__heading">
            <span>Bienvenu</span>
            <span className="hero__name">Farouk Gouadria</span>
          </h1>
          ...
          <div className="hero__social">
            ...
            <div className="hero__social__text">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/farouk.gouadri"
                    target="_blank"
                    rel="noreferrer"
                  >
                    FB
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/farouk-gouadria-35587b18b/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    LI
                ...
                <li>
                  <a
                    href="https://www.instagram.com/frouga_gr/?hl=fr"
                    target="_blank"
                    rel="noreferrer"
                  >
                    IG
                ...
                <li>
                  <a
                    href="https://github.com/FaroukGouadria"
                    target="_blank"
                    rel="noreferrer"
                  >
                    GH
